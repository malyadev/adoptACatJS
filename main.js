...
const animalsToAdopt = [
    {
        name: "Lucky",
        picture: "https://placekitten.com/200/400"
    },
    {
        name: "Symba",
    ...
    {
        name: "Léo",
        picture: "https://placekitten.com/200/910"
    },
    {
        name: "Milo",
...
function createCard(title, imageUrl) {
    ...
    // Step2: Create the cardTitle h2, add the class card-title and add it to the cardBody
    const h2 = document.createElement("h2");
    h2.innerHTML = `${title}`;
    h2.classList.add("card-title");
    cardBody.appendChild(h2);

    // Step3: Create the cardButton button, add the class card-button and add it to the cardBody
...
for (let i = 0; i < animalsToAdopt.length; i++){
    ...
    console.log(animalsToAdopt[i].name)
}